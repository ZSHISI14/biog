  ...
  root.ontouchmove = function (e) {
    ...
    clock = setTimeout(function () {
      ...
      if (moveEndX - startX > 50) {
        ...
        eventHub['swipDown'].forEach(function (fn) {
          return fn.bind(root)();
        });
      } else if (startY - moveEndY > 50) {
        eventHub['swipUp'].forEach(function (fn) {
          return fn.bind(root)();
        });
      }
    }, 100);
  ...
  _createClass(Player, [{
    ...
    value: function bind() {
      ...
      this.root.querySelector('.timebar').onclick = function (e) {
        var precent = e.offsetX / this.clientWidth; //点击位置在进度条的百分比
      ...
      var swiper = new _swiper.default('.area-effect');
      swiper.on('swipLeft', function () {
        this.classList.add('panelRight');
    ...
    value: function renderSong() {
      ...
      }; //当audio的src加载完，可以直接读取audio的duration
    ...
    value: function loadlyric() {
      ...
      fetch(this.songList[this.currentIndex].lyric).then(function (res) {
        ...
        return _this4.setlyrics(data.lrc.lyric);
      });
    }
  }, {
    key: "setlyrics",
    value: function setlyrics(lyrics) {
      ...
      lyrics.split(/\n/).filter(function (str) {
        ...
        line.match(/\[.+?\]/g).forEach(function (t) {
          t = t.replace(/[\[\]]/g, '');
          var milliseconds = t.slice(0, 2) * 1000 * 60 + t.slice(3, 5) * 1000 + parseInt(t.slice(6));

          _this5.lyricsArr.push([milliseconds, str]);
        });
      });
    ...
    key: "lyricTO",
    value: function lyricTO() {
      var currentTime = this.audio.currentTime * 1000;
      var n = this.lyricsArr.length;
    ...
    key: "centerLyricLight",
    value: function centerLyricLight(node) {
      var offset = node.offsetTop - this.$('.panel-lyricd').offsetHeight / 2; //歌词居中时歌词容器的偏移距离为歌词距容器顶部的距离减去窗口的一半高度

      offset > 0 ? offset : 0;
      this.$('.lyrics-container').style.transform = "translateY(-".concat(offset, "px)");
      this.$$('.lyrics-container p').forEach(function (node) {
    ...
    value: function setProgress() {
      var precent = this.audio.currentTime * 100 / this.audio.duration + '%'; //都是以秒计算*100是应为百分比
    ...
    value: function formateTime(secondsTotal) {
      var minute = parseInt(secondsTotal / 60);
    ...
    value: function btnToPlay() {
      var btnToPlay = this.root.querySelector('.btn-play-pause');
    ...
    value: function setballs() {
      var balls = this.root.querySelectorAll('.balls span');
...
new Player('#player');
},{"./icons":"src/javascript/icons.js","./swiper.js":"src/javascript/swiper.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","src/javascript/index.js"], null)
